...
public class Thread_1 extends Thread{
    ...
    public Thread_1(allOclockController allController) {
        this.allOclock = allController;
    }
    public Thread_1(oclockControllers controller) {
    ...
    private void updateAllTime() {
        ...
        Platform.runLater(() -> {
            allOclock.getGMT_1().setText(timeH);
        });
    }
    private void updateTime() {
        String timeH = getTimeH();
        Platform.runLater(() -> {
            controller.getMui_1().setText(timeH);
